...
main(){
    ...
    float numCarros, totalVendas, salarioFixo, valorPorCarro, SalarioFinal, porcetagemVendas = 0.05;
    ...
    SalarioFinal = (valorPorCarro * numCarros) + (totalVendas * porcetagemVendas) + salarioFixo;
